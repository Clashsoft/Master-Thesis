...
Tabelle~\ref{tbl:pm-effectiveness} zeigt für jede Hausaufgabe die Anzahl der Bewertungen von \textbf{Code Search} und \textbf{händisch} Bewertenden.
...
Die drei Werte werden in der Spalte \textbf{Gesamt} summiert, sodass die Effektivität durch Anteil von Code Search zu Gesamt berechnet werden kann.
