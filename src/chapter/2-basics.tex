...
Ein:e Professor:in oder Mitarbeiter:in, nachfolgend zusammengefasst als Übungsleitung bezeichnet, steuert den Übungsbetrieb. % TODO Gender :?
...
% Insbesondere befindet sich hier das Benutzerhandbuch von fulibFeedback. TODO fulibFeedback sollte hier nicht einfach so genannt werden
...
Zunächst soll beschrieben werden, wie der Stand des Moduls gegen Ende von~\cite{bachelor-thesis} war.
...
Dadurch konnten Probleme vermieden werden, die durch die Verwendung unterschiedlicher \acp{ide} entstehen können. % TODO Bsp
