...
Für die Evaluation wurden insgesamt \todo{drei} der elf Aufgabenblätter von Anfang, Mitte und Ende des Semesters ausgewählt und jeweils etwa 20\% der Abgaben eingeschränkt bewertet.
...
Es ist nun möglich, Archive über ein Import-Fenster hochzuladen, wie Abbildung~\todo{} zeigt.
...
Durch Code Search wurden einige weitere Lösungen in Teilen \textbf{bewertet}.
