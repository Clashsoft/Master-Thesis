...
Folgt eine Zeile nicht diesem Format, wird sie rot markiert, um den Benutzenden auf das Problem hinzuweisen.
...
\begin{description}
    ...
    Das verlängerte Öffnen dieses Fensters, beispielsweise beim Verlassen des Arbeitsplatzes oder beim Einlegen einer Pause, kann die Statistik verfälschen.
